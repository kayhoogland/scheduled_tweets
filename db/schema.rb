...
ActiveRecord::Schema.define(version: 2021_03_20_114156) do
  ...
  create_table "twitters", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["twitter_account_id"], name: "index_twitters_on_twitter_account_id"
  ...
  add_foreign_key "twitters", "twitter_accounts"
